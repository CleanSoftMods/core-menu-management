...
@section('content')
    <div class="layout-2columns sidebar-left">
        <div class="column left">
            @php do_action(BASE_ACTION_META_BOXES, 'top-sidebar', 'webed-menus.edit', $object) @endphp
            @include('webed-menus::admin._partials.custom-link')
            {!! menus_management()->renderWidgets() !!}
            @php do_action(BASE_ACTION_META_BOXES, 'bottom-sidebar', 'webed-menus.edit', $object) @endphp
        </div>
        <div class="column main">
            ...
            @php do_action(BASE_ACTION_META_BOXES, 'main', 'webed-menus.edit', $object) @endphp
            {!! Form::close() !!}
        </div>
    </div>
@endsection
